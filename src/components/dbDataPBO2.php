            ...
            function addPerson($person){
               ...
               $orang = array();
                ...
                $sql = "INSERT INTO Person (
                   firstName, lastName, sport, years, vegetarian)"."VALUES ('"
                   . $orang["firstName"]."','"
                   . $orang["lastName"]."','"
                   . $orang["sport"]."','"
                   . $orang["years"]."','"
                    ...
                    if ($conn->query($sql) === TRUE) {
                          $msg =  "New record created successfully";
                           ...
                           return new xmlrpcresp(new xmlrpcval($msg));
                             ...
                             while(list($key, $v) = $val->structEach()){
                                $orang[$key] = $v->scalarVal(); }
                                    $sql = "UPDATE Person ". "SET " . "PersonID = '".$orang["PersonID"]. "', " . "firstName = '".$orang["firstName"]."', " . "lastName = '".$orang["lastName"]."', " . "sport = '".$orang["sport"]."', " . "years = '".$orang["years"]."', " . "vegetarian = '".(($orang["vegetarian"]==1)? 1 : 0 )."' "
                                                         ...
                                                         if ($conn->query($sql) === TRUE) {
                                                             $msg =  "The record has been deleted successfully";
                                                                   ...
                                                                   function populatePerson() {
                                                                         ...
                                                                         setUpConnection();
                                                                         $sql = "SELECT "."PersonID, firstName, lastName, sport, years, vegetarian "
                                                                              ."FROM Person";
